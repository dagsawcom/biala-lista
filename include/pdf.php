...
//require_once('/home/ffcehxep/domains/pdf/examples/tcpdf_include.php');
...
$html2b = explode('class="twofirst1">',$html2a);
$html2c = explode('</td><td id="serh" ',$html2b[1]);
$html2ba = explode('<div class="container" id="tableOne">',$html2a);


//$html2 = '<div class="container" id="tableOne">';
//<table class="modal-content" id="chow"><tbody><tr><td class="modal-header"><div class="modal-title" id="exampleModalScrollableTitle">NAZWA: 'DSV ROAD' SPÓŁKA Z OGRANICZONĄ ODPOWIEDZIALNOŚCIĄ NIP: 1130017933</div></td></tr></tbody></table>
$html2d = $html2b[0].'class="twofirst1">Stan na dzień: '.$dat.'</td><td id="serh" '.$html2c[1];
...
//echo $_SERVER['DOCUMENT_ROOT'].'/test/'.$name.'.pdf';
$pdf->Output($_SERVER['DOCUMENT_ROOT'].'test/'.$name.'.pdf', 'F');
